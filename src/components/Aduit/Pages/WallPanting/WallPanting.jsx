...
export const WallPainting = () => {
  ...
  const [selectedAroma, setSelectedFloor] = useState(null);
  const [selectedTaste, setSelectedTaste] = useState(null);
  const [remark, setRemark] = useState('');
  const [rating, setRating] = useState(0);
 

  const handleFanClick = (option) => setSelectedFan(option);
  const handleLightClick = ( Light ) => setSelectedLight( Light);
  const handleCellingClick = ( Celling) => setSelectedTemperature( Celling);
  const handleWallClick = ( wall) => setSelectedWall( wall);
  const handleFloorClick = ( floor) => setSelectedFloor( floor);
          ...
          <div className="flex space-x-4">
            {['Good', 'Bad'].map((fan) => (
              <div
                ...
                className={`cursor-pointer px-4 py-2 poppins-medium rounded-full border flex items-center justify-center transition-colors duration-200 hover:bg-red-600 hover:text-white ${selectedFan === fan ? 'bg-red-600 text-white' : 'bg-white text-gray-700 border-gray-300'}`}
              >
                {fan}
              </div>
            ))}
          ...
          <div className="flex space-x-4">
            {['Good', 'Bad'].map((Light) => (
              <div
                ...
                className={`cursor-pointer px-4 py-2 poppins-medium rounded-full border flex items-center justify-center transition-colors duration-200 hover:bg-red-600 hover:text-white ${selectedLight === Light ? 'bg-red-600 text-white' : 'bg-white text-gray-700 border-gray-300'}`}
              >
                {Light}
              </div>
            ))}
          ...
          <div className="flex space-x-4">
            {['Good', 'Bad'].map((Celling) => (
              <div
                ...
                className={`cursor-pointer px-4 py-2 poppins-medium rounded-full border flex items-center justify-center transition-colors duration-200 hover:bg-red-600 hover:text-white ${selectedTemperature === Celling ? 'bg-red-600 text-white' : 'bg-white text-gray-700 border-gray-300'}`}
              >
                {Celling}
              </div>
            ))}
          ...
          <div className="flex space-x-4">
            {['Good', 'Bad'].map((wall) => (
              <div
                ...
                className={`cursor-pointer px-4 py-2 poppins-medium rounded-full border flex items-center justify-center transition-colors duration-200 hover:bg-red-600 hover:text-white ${selectedWall === wall ? 'bg-red-600 text-white' : 'bg-white text-gray-700 border-gray-300'}`}
              >
                {wall}
              </div>
            ))}
          ...
          <div className="flex space-x-4">
            {['Good', 'Bad'].map((floor) => (
              <div
                ...
                className={`cursor-pointer px-4 py-2 poppins-medium rounded-full border flex items-center justify-center transition-colors duration-200 hover:bg-red-600 hover:text-white ${selectedAroma === floor ? 'bg-red-600 text-white' : 'bg-white text-gray-700 border-gray-300'}`}
              >
                {floor}
              </div>
            ))}
