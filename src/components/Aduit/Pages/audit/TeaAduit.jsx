    ...
    <>
      ...
      <form
        onSubmit={(e)=>{
          e.preventDefault();
          setIsModalOpen(true)}}
        className="w-full space-y-4 mx-auto p-4 md:p-8"
      >
        <div className="flex flex-col bg-white p-4 md:p-6 rounded-lg shadow-md">
              ...
              <div className="flex space-x-2 sm:space-x-4">
                {["good", "bad"].map((tea) => (
                  <div
                    ...
                    className={`cursor-pointer capitalize  px-3 py-1 mt-2 rounded-full border flex items-center justify-center transition-colors duration-200 hover:bg-red-600 hover:text-white ${
                      selectedTea === tea
          ...
          <button
            ...
            className={`mt-4 w-full text-center py-2 rounded-md text-white ${
              isTesSubmitted ? "bg-green-600" : "bg-red-600 hover:bg-red-700"
            } ` }
          >
            {isTesSubmitted ? (
