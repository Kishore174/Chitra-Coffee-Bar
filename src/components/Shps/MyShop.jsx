  ...
  return (
    <div className="p-4 md:p-6 min-h-screen ">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 md:mb-6">
        ...
        <Link to="/addshop">
          <button className="bg-red-600 text-white poppins-regular rounded-lg p-3 flex items-center">
      ...
      <div className="overflow-x-auto  rounded-lg">
        <table className="max-w-full bg-white border hidden lg:table">
          ...
          <tbody>
            {shops.map((shop, index) => (
              <tr key={shop.id} className="hover:bg-gray-100   rounded-lg" >
                <td className="px-2 py-4 border-b border-gray-200 text-xs md:text-sm">{index + 1}</td>
                <td className="px-2 py-4 border-b poppins-regular  border-gray-200 text-xs md:text-sm">{shop.name}</td>
                <td className="px-2 py-4 border-b poppins-regular border-gray-200 text-xs md:text-sm">
                  {shop.location} <br />
                  <a href={shop.mapLink} className="text-blue-500 poppins-regular hover:underline" target="_blank" rel="noopener noreferrer">
                    Map Link
                  </a>
                </td>
                <td className="px-2 py-4 border-b poppins-regular border-gray-200 text-xs md:text-sm">
                  {shop.contact} <br />
                  <a href={`mailto:${shop.email}`} className="text-blue-500  poppins-regular hover:underline">
                    {shop.email}
                  </a>
                </td>
                <td className="px-2 py-4 border-b poppins-regular  border-gray-200 text-xs md:text-sm">{shop.franchise}</td>
                <td className="px-2 py-4 border-b poppins-regular border-gray-200 text-xs md:text-sm">{shop.partnership}</td>
                <td className="px-2 py-4 border-b poppins-regular border-gray-200 space-x-2 text-xs md:text-sm">
                  <button className="text-blue-500 poppins-regular hover:underline p-1">Views</button>
                  <button className="text-green-500 hover:underline p-1"><GrEdit /></button>
                  <button className="text-red-500 hover:underline p-1">
                    <MdDelete  size={20}/>
                  </button>
                </td>
              </tr>
          ...
          {shops.map((shop, index) => (
            <div key={shop.id} className="bg-white mb-4 p-4 rounded-lg shadow">
              <div className="flex justify-between items-center mb-2">
                <h2 className="text-lg poppins-regular">{shop.name}</h2>
