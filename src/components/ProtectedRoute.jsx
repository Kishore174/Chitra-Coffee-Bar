...
const ProtectedRoute = () => {
  ...
  const path = location.pathname;
    ...
    else if (path.startsWith('/attendance-management')) requiredPerm = '/attendance-management';
    else if (path.startsWith('/attendance')) requiredPerm = '/attendance';
    else if (path.startsWith('/leave-management')) requiredPerm = '/leave-management';
    ...
    else if (path.startsWith('/complaint-request') || path.startsWith('/add-complaint') || path.startsWith('/edit-complaint')) requiredPerm = '/complaint-request';
    else if (path.startsWith('/complaint-management')) requiredPerm = '/complaint-management';
    else if (path.startsWith('/setting') || path.startsWith('/backeryproducts') || path.startsWith('/brandName') || path.startsWith('/livesnackname')) requiredPerm = '/setting';
    else if (path.startsWith('/employees') || path.startsWith('/add-employees')) requiredPerm = '/employees';
    else if (path.startsWith('/audit-config')) requiredPerm = '/audit-config';
    else if (path.startsWith('/devices')) requiredPerm = '/devices';
